      ...
      <div className="relative max-w-[760px] p-7 md:p-10 lg:p-12">
        ...
        <Reveal delay={240}>
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <Link
              href="/krouzky"
              className="inline-flex items-center gap-2 rounded-brand bg-gradient-brand px-5 py-4 text-sm font-black text-white shadow-brand-soft transition-transform hover:-translate-y-0.5"
            >
              Rezervovat kroužek
              <ArrowRight size={18} />
            </Link>
            <Link
              href="/sign-in"
              className="inline-flex items-center gap-2 rounded-brand border border-brand-purple/15 bg-brand-paper px-5 py-4 text-sm font-extrabold text-brand-ink transition-colors hover:bg-brand-purple-light"
            >
              Přihlásit se
              <ArrowRight size={18} />
            </Link>
