...
const styles = StyleSheet.create({
  ...
  formGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.md, marginTop: Spacing.md },
  ...
  payoutButton: { alignSelf: 'flex-start', marginTop: Spacing.md, backgroundColor: CoachColors.teal, borderRadius: Radius.pill, paddingHorizontal: Spacing.lg, paddingVertical: 10 },
